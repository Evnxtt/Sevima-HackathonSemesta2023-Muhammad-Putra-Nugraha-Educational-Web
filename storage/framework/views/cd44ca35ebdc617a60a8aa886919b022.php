        	...
        	<div class="max-w-6xl w-full mx-auto sm:px-6 lg:px-8 space-y-4 py-4">
            	...
            	<div class="w-full rounded-md bg-white border-2 border-gray-600 p-4 min-h-[60px] h-full text-gray-600">
                	<form action="/chat/generate" method="post" class="inline-flex gap-2 w-full">
                    	<?php echo csrf_field(); ?>
                    	<input required name="title" class="w-full outline-none text-2xl font-bold" value="<?php echo e($title); ?>" placeholder="Type your article title..." />
            	...
            	<div class="w-full rounded-md bg-white border-2 border-gray-600 p-4 min-h-[720px] h-full text-gray-600">
                	<textarea class="min-h-[500px] h-full w-full outline-none" spellcheck="false"><?php echo e($content); ?></textarea>
            	</div>
            	<?php endif; ?>
        	</div>
    	</div>
...
</html><?php /**PATH C:\xampp\htdocs\Hackaton\resources\views/chat.blade.php ENDPATH**/ ?>